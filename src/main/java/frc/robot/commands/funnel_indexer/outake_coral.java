...
public class outake_coral extends Command {
  ...
  public void initialize() {
    m_end_effector_subsystem.setMotorSpeed(Constants.EndEffectorConstants.OUTTAKE_SPEED);
  }
