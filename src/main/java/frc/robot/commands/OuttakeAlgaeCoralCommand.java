...
public class OuttakeAlgaeCoralCommand extends Command {

  private AlgaeCoralIndexerSubsystem m_algaeCoralIndexerSubsystem;

  /** Creates a new OuttakeAlgaeCoralCommand. */
  public OuttakeAlgaeCoralCommand(AlgaeCoralIndexerSubsystem algaeCoralIndexerSubsystem) {
  ...
  public void initialize() {
    m_algaeCoralIndexerSubsystem.setSpeed(AlgaeCoralIndexerConstants.kOuttakeSpeed);
