...
public class OperatorSetPositionCommand extends Command {
  /** Creates a new OperatorSetPositionCommand. */
  ElevatorPosition position;
  public OperatorSetPositionCommand(ElevatorPosition position) {
