...
public class IntakeAlgaeCommand extends Command {
  ...
  public IntakeAlgaeCommand(AlgaeCoralIndexerSubsystem algaeCoralIndexerSubsystem) {
  ...
  public void initialize() {
    m_algaeCoralIndexerSubsystem.setMotorVoltage(AlgaeCoralIndexerConstants.INTAKE_ALGAE_VOLTAGE);
  }
