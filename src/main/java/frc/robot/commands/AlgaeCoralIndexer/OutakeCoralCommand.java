...
public class OutakeCoralCommand extends Command {
  ...
  public OutakeCoralCommand(AlgaeCoralIndexerSubsystem algaeCoralIndexerSubsystem) {
  ...
  public void initialize() {
    m_algaeCoralIndexerSubsystem.setMotorVoltage(AlgaeCoralIndexerConstants.OUTTAKE_CORAL_VOLTAGE);
  }
