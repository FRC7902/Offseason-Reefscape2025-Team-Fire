...
package frc.robot.commands.AlgaeCoralIndexer;
...
public class OuttakeAlgaeCommand extends Command {
  ...
  public OuttakeAlgaeCommand(AlgaeCoralIndexerSubsystem algaeCoralIndexerSubsystem) {
  ...
  public void initialize() {
    m_algaeCoralIndexerSubsystem.setMotorVoltage(AlgaeCoralIndexerConstants.OUTTAKE_ALGAE_VOLTAGE);
  }
